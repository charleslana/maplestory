...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // Loading Screen
  Color? loadingScreenColor = Colors.blue[100];
  bool isTextVisible = true;
  Color tapToPlayColor = Colors.white;
  int loadingTime = 3;
  ...
  void jump() {
    double time = 0;
    double height = 0;
    final double initialHeight = boyPosY;
  ...
  void collectItem() {
    double time = 0;
    double height = 0;
    final double initialHeight = cashPosY;
    Timer.periodic(const Duration(milliseconds: 70), (timer) {
      time += 0.05;
      height = -4.9 * time * time + 2.5 * time;
  ...
  void releaseItem() {
    ...
    double time = 0;
    double height = 0;
    final double initialHeight = snailPosY;
    Timer.periodic(const Duration(milliseconds: 100), (timer) {
      time += 0.05;
      height = -4.9 * time * time + 2.5 * time;
